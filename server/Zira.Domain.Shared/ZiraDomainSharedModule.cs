...
public class ZiraDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ZiraGlobalFeatureConfigurator.Configure();
        ZiraModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ZiraDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options
                .Resources.Add<ZiraResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Zira");

            options.DefaultResourceType = typeof(ZiraResource);
        ...
        {
            options.MapCodeNamespace("Zira", typeof(ZiraResource));
        });
    }
}
