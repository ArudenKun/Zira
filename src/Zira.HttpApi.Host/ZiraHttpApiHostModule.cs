...
using Zira.HealthChecks;
using Zira.MultiTenancy;

namespace Zira;

[DependsOn(
    typeof(ZiraHttpApiModule),
...
public class ZiraHttpApiHostModule : AbpModule
{
    ...
    private void ConfigureConventionalControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(ZiraApplicationModule).Assembly);
        });
    }
    ...
    )
    {
        context.Services.AddAbpSwaggerGenWithOidc(
            ...
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "Zira API", Version = "v1" });
    ...
    {
        context.Services.AddZiraHealthChecks();
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "Zira API");
